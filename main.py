...
def main(args):
    ...
    for fb in range(0, len(train_files), FILE_BATCH):
        ...
        clear_images, noise_images = gen_large_train_set(clear_images, noise_images, 
                                                         BLOCK_SIZE, BATCH_SIZE, NUM_BLOCK, OVERLAP)
        encoder, decoder = train_encoder(noise_images, clear_images, encoder, decoder, EPOCH)
